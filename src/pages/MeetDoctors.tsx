  ...
  return (
    <div className="flex flex-col min-h-screen pt-32">
      ...
      <section className="bg-[#1e4682] py-20 lg:py-32 relative">
        <ScrollReveal direction="up" className="container mx-auto px-4 lg:px-8 text-center text-white">
      ...
      <section className="py-20 flex-grow bg-white">
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
             <ScrollReveal direction="right" className="rounded-md overflow-hidden shadow-2xl relative">
